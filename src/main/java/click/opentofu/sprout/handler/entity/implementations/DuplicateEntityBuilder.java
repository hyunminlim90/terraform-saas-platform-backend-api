...
@Component("duplicate_entity_builder_sprout")
public class DuplicateEntityBuilder implements EntityHandler {
    
    private final TofuRepository tofuRepository;

    @Override
    public void duplicateBuildEntityAndSave(JsonNode parameters, String authUserIndex, String accountId, String region) {
        try {
