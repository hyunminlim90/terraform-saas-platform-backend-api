...
public class EmitterRouteTableAssociation {
    ...
    @PostMapping(path = "/aws-resources/issue-unique-id/aws_route_table_association")
    ...
    @PostMapping(path = "/aws-resources/exec-tofu-plan/aws_route_table_association")
    ...
    @PostMapping(path = "/aws-resources/exec-tofu-apply/aws_route_table_association")
    ...
    @PostMapping(path = "/aws-resources/exec-tofu-plan-destroy/aws_route_table_association")
    ...
    @PostMapping(path = "/aws-resources/exec-tofu-destroy/aws_route_table_association")
