...
public class EmitterInstance {
    ...
    @PostMapping(path = "/aws-resources/issue-unique-id/aws_instance")
    ...
    @PostMapping(path = "/aws-resources/exec-tofu-plan/aws_instance")
    public CompletableFuture<ResponseEntity<Map<String, Object>>> cleanUpDirectoryPlan (
        @RequestBody ResourceDto resourceDto,
        HttpServletRequest request
    ) {
        resourceDto.setModuleName("aws_instance");
    ...
    @PostMapping(path = "/aws-resources/exec-tofu-apply/aws_instance")
    ...
    @PostMapping(path = "/aws-resources/exec-tofu-plan-destroy/aws_instance")
    ...
    @PostMapping(path = "/aws-resources/exec-tofu-destroy/aws_instance")
