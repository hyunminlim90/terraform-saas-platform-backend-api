...
public class EmitterSubnet {
    ...
    @PostMapping(path = "/aws-resources/issue-unique-id/aws_subnet")
    ...
    @PostMapping(path = "/aws-resources/exec-tofu-plan/aws_subnet")
    public CompletableFuture<ResponseEntity<Map<String, Object>>> cleanUpDirectoryPlan (
        @RequestBody ResourceDto resourceDto,
        HttpServletRequest request
    ) {
        resourceDto.setModuleName("aws_subnet");
    ...
    @PostMapping(path = "/aws-resources/exec-tofu-apply/aws_subnet")
    ...
    @PostMapping(path = "/aws-resources/exec-tofu-plan-destroy/aws_subnet")
    ...
    @PostMapping(path = "/aws-resources/exec-tofu-destroy/aws_subnet")
