...
public class EmitterSecurityGroup {
    ...
    @PostMapping(path = "/aws-resources/issue-unique-id/aws_security_group")
    ...
    @PostMapping(path = "/aws-resources/exec-tofu-plan/aws_security_group")
    public CompletableFuture<ResponseEntity<Map<String, Object>>> cleanUpDirectoryPlan (
        @RequestBody ResourceDto resourceDto,
        HttpServletRequest request
    ) {
        resourceDto.setModuleName("aws_security_group");
    ...
    @PostMapping(path = "/aws-resources/exec-tofu-apply/aws_security_group")
    ...
    @PostMapping(path = "/aws-resources/exec-tofu-plan-destroy/aws_security_group")
    ...
    @PostMapping(path = "/aws-resources/exec-tofu-destroy/aws_security_group")
