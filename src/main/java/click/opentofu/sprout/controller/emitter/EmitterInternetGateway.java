...
public class EmitterInternetGateway {
    ...
    @PostMapping(path = "/aws-resources/issue-unique-id/aws_internet_gateway")
    ...
    @PostMapping(path = "/aws-resources/exec-tofu-plan/aws_internet_gateway")
    public CompletableFuture<ResponseEntity<Map<String, Object>>> cleanUpDirectoryPlan (
        @RequestBody ResourceDto resourceDto,
        HttpServletRequest request
    ) {
        resourceDto.setModuleName("aws_internet_gateway");
    ...
    @PostMapping(path = "/aws-resources/exec-tofu-apply/aws_internet_gateway")
    ...
    @PostMapping(path = "/aws-resources/exec-tofu-plan-destroy/aws_internet_gateway")
    ...
    @PostMapping(path = "/aws-resources/exec-tofu-destroy/aws_internet_gateway")
