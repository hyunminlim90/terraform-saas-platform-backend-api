...
public class EmitterVpcIpamPool {
    ...
    @PostMapping(path = "/aws-resources/issue-unique-id/aws_vpc_ipam_pool")
    ...
    @PostMapping(path = "/aws-resources/exec-tofu-plan/aws_vpc_ipam_pool")
    ...
    @PostMapping(path = "/aws-resources/exec-tofu-apply/aws_vpc_ipam_pool")
    ...
    @PostMapping(path = "/aws-resources/exec-tofu-plan-destroy/aws_vpc_ipam_pool")
    ...
    @PostMapping(path = "/aws-resources/exec-tofu-destroy/aws_vpc_ipam_pool")
