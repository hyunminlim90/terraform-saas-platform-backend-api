package click.opentofu.sprout.controller.resource.save;
...
public class SaveResourceInternetGateway {
    ...
    @PostMapping(path = "/aws-resources/save-resource/aws_internet_gateway")
